...
export class ECSDeployment extends Construct {
  ...
  private createMeilisearchService(props: ECSDeploymentProps, securityGroup: ec2.SecurityGroup): ecs.FargateService {
  ...
  private createRagService(props: ECSDeploymentProps, securityGroup: ec2.SecurityGroup): ecs.FargateService {
  ...
  private createLibreChatService(props: ECSDeploymentProps, securityGroup: ec2.SecurityGroup): ecs.FargateService {
  ...
  private configureListener(props: ECSDeploymentProps, targetGroup: elbv2.ApplicationTargetGroup): void {
  ...
  private buildMongoUri(props: ECSDeploymentProps): string {
    ...
    return `mongodb://\${MONGO_USER}:\${MONGO_PASSWORD}@${endpoint}:27017/?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false`;
  }
}
